...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            ...
            await conn.sendMessage(conn.user.jid, "```Garfield Running```", MessageType.text);
            await conn.sendMessage(conn.user.jid, "```PROGRAM WORKING" + config.WORKTYPE + "```" , MessageType.text);
    });
	...
	if (config.NOLOG == 'true') {
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '__PROGRAM_CRASHED_[error] ' +
                                    '\n\n*🐼 ' + error + '*\n'
                                    , MessageType.text);
			      }
                            }
