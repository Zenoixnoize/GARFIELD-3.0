...
let { textRepeterSew, checkIsGroup, checkUsAdmin, checkImAdmin}= require('pinky/sources/dc/cmd/admin');
...
pinky['IntroduceCMD']({pattern: 'antispam', fromMe: true, delownsewcmd: false, dontAdCommandList: true}, (async (message, input) => {
...
pinky['IntroduceCMD']({pattern: 'antispam', fromMe: false, delownsewcmd: false, dontAdCommandList: true}, (async (message, input) => {
var gp = await checkIsGroup(message)
             if(!gp) return;
