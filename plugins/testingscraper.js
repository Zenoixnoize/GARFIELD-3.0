...
if (config.WORKTYPE == 'private') {
    ...
    MyPnky.addCommand({pattern: 'voice (.*)', fromMe: false, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    MyPnky.addCommand({pattern: 'music ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({pattern: 'video ?(.*)', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,Lang.DOWNLOADING_VIDEO,MessageType.text, {quoted : {
            ...
            message: {
              "extendedTextMessage": {
                "text": "```Garfield downloading video```"
              }
            }
        }
        });
    ...
    MyPnky.addCommand({pattern: 'sig ?(.*)', fromMe: false, desc: Lang.SING_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({pattern: 'imusic ?(.*)', fromMe: false, desc: Lang.ISONG_DESC}, (async (message, match) => { 
    ...
    MyPnky.addCommand({ pattern: 'git ?(.*)', fromMe: false, desc: Glang.GİTHUB_DESC }, async (message, match) => {
    ...
    MyPnky.addCommand({pattern: 'lyr ?(.*)', fromMe: false, desc: Slang.LY_DESC }, (async (message, match) => {
    ...
    MyPnky.addCommand({pattern: "coid ?(.*)", fromMe: false, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
                //const resp = await fetch("https://coronavirus-19-api.herokuapp.com/all").then(r => r.json());
                const respo = await got("https://coronavirus-19-api.herokuapp.com/all").then(async ok => {
