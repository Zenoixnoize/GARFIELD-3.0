...
let DataPack = require('host');
let pinky = require('host/sources/dc/handler');
let Details = require('host/sources/dc/Details');
let Language = DataPack.constdata
let WorkType = Details.WORKTYPE == 'public' ? false : true
let { MessageType, Mimetype} = require('@ravindu01manoj/sew-queen-web');
let { sendMessageDownloader, sendMessageBrodcast, sendMessageAddBrodcast, downloadapkpinky, downloadtwitterpinky} = require('host/sources/dc/cmd/dl')
let { ytdocdlBackupForpinky } = require('host/sources/dc/cmd/yt')
...
await sendMessageDownloader(QueenSew, input, 'dlvid');
                        ...
                        try{
                        await ytdocdlBackupForpinky(QueenSew, input)
                              }  catch(e) {
